...
type RoomRepository interface {
	ListRooms(ctx context.Context, status *domain.RoomStatus) ([]domain.Room, error)
	FindRoomByID(ctx context.Context, id uuid.UUID) (*domain.Room, error)
	FindAvailableRoom(ctx context.Context, roomType *string) (*domain.Room, error)
	CreateRoom(ctx context.Context, r *domain.Room) (*domain.Room, error)
	UpdateRoomStatus(ctx context.Context, id uuid.UUID, status domain.RoomStatus) error

	CreateStay(ctx context.Context, s *domain.GuestStay) (*domain.GuestStay, error)
	FindStayByID(ctx context.Context, id uuid.UUID) (*domain.GuestStay, error)
	ListStays(ctx context.Context, filters map[string]interface{}) ([]domain.GuestStay, error)
	UpdateStay(ctx context.Context, id uuid.UUID, fields map[string]interface{}) error
	DeleteStay(ctx context.Context, id uuid.UUID) error

	SmartCheckinLookup(ctx context.Context, guestName, phone string) (*domain.GuestStay, error)
}
...
func (r *roomRepository) UpdateStay(ctx context.Context, id uuid.UUID, fields map[string]interface{}) error {
